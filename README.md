...
- Required plugins: `ai-core`, `knowledge-core`, `jobs-core`
- Recommended plugins: none
...
| --- | --- | --- |
| Actions | 7 | `ai.memory.ingest`, `ai.memory.retrieve`, `ai.memory.reindex`, `ai.memory.review`, `ai.memory.promote`, `ai.knowledge-pipelines.upsert`, `ai.memory-candidates.promote` |
| Resources | 5 | `ai.memory-collections`, `ai.memory-documents`, `ai.retrieval-diagnostics`, `ai.knowledge-pipelines`, `ai.memory-candidates` |
